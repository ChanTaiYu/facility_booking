                                ...
                                <div class="p-5">
                                    ...
                                    <form class="user" method="POST" action="auth.php" >
                                        ...
                                        <input type="hidden" class="form-control form-control-user rounded"
                                                id="role" name="role" value="patient" required >
                                        ...
                                        <input type="hidden" class="form-control form-control-user rounded"
                                                id="action" name="action" value="register" required >
                                        

                                        <div>Already have account? <a href="index.php">Login now</a></div>

                                        <input type="submit" value="REGISTER" name="register" class="btn btn-black btn-user btn-block mt-4 mb-2 rounded">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-12 col-md-12 mb-2 mb-md-0">
                                            <a class="btn btn-dark rounded w-100" href="admin-login.php">
                                                <img src="img/admin.png" width="20" />
                                                Admin
                                            </a>
                                        </div>
