<?php 
 ...
 <?php
    ...
    if( isset($_GET["eid"]) ){
        ...
        echo "<script>alert('Select one admin.');</script>";
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    <div class="d-flex align-items-center justify-content-between">
                        <h1 class="h3 mb-2 text-gray-800 display-7">Update Admin</h1>
                                    ...
                                    <form method="POST" action="functions.php" enctype="multipart/form-data">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-12 col-md-12">
                                                ...
                                                <input type="hidden" class="form-control" id="action" name="action" required value="update-admin">
