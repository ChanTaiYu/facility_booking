...
<body id="page-top">
            ...
            <div id="content">
                ...
                <div class="container-fluid" id="form-table">
                    ...
                    <div class="d-flex align-items-center justify-content-between">
                        <h1 class="h3 mb-2 text-gray-800 display-7">My Booking</h1>
                    </div>
    ...
    $(document).ready(function() {
        ...
        $('a[href="my-booking.php"]').parent().addClass('active');
                            ...
                            $('#tableBody').append(`
                                <tr data-id="${d.booking_id}">
                                    ...
                                    <td>
                                        ...
                                        <p <p class="mt-0 mb-0">Location: ${d.facility_location}</p>
                                    </td>
