<?php 
 ...
 <?php
        ...
        $edtid = $uid;
        $sqlE = "SELECT * FROM admin WHERE id = '$edtid'";
...
<body id="page-top">
                                ...
                                <div class="card-body p-5">
                                    ...
                                    <form method="POST" action="functions.php" enctype="multipart/form-data">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-12 col-md-12">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="email" class="form-control" id="email" name="email" placeholder="Enter Email"  value="<?php echo $rowE['email']; ?>" disabled>
                                                </div>
                                                ...
                                                <input type="hidden" class="form-control" id="action" name="action" required value="update-admin-profile">
                                        ...
                                        <div class="my-3 text-center">
                                            <input class="btn btn-purple btnAction" type="submit" value="Update" name="update-admin-profile" />
                                        </div>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            ...
            $('a[href="admin-profile.php"]').parent().addClass('active');
